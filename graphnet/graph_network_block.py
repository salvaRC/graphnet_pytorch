...
from graphnet.mlp import MLP
import graphnet.constants as gn_constants
from graphnet.constants import GraphComponentToTensor, AggregationTypes, NODES, EDGES, GLOBALS
...
class GraphNetBlock(nn.Module):
    ...
    @property
    def n_edges(self):
        """ Returns the currently used number of edges, can be updated to a new edge/graph structure
            by calling update_graph_structure(.) """
